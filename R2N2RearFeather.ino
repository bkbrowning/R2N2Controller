/* --------------------------
   ...
   This specific reseciver is configured to operate the mechanisms on the REAR BODY portion of the R2 unit.
...
#define MY_RADIO_ADDRESS  30  // Must be a UNIQUE number for each radio within the radio group
...
//
#define REARBODYI2C 30
int myi2c = REARBODYI2C; // the i2c address of this device
...
void setup() {
  ...
  Serial.println("Beginning setup and intialization routines for the REARBODY controller...");
  ...
  delay(500);
  Serial.println("Setup COMPLETE for the REARBODY controller!");
} // setup()
