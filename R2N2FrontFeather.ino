/* --------------------------
   ...
   This specific reseciver is configured to operate the mechanisms on the FRONT BODY portion of the R2 unit.
...
#define MY_RADIO_ADDRESS  20  // Must be a UNIQUE number for each radio within the radio group
...
//
#define FRONTBODYI2C 20
int myi2c = FRONTBODYI2C; // the i2c address of this device
...
void setup() {
  ...
  Serial.println("Beginning setup and intialization routines for the FRONTBODY controller...");
  ...
  delay(500);
  Serial.println("Setup COMPLETE for the FRONTBODY controller!");
} // setup()
